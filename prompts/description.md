...
polytype is a companion for Golang RAG applications, that generates
...
//go:generate go run github.com/tylergannon/polytype/polytype/ --pretty
...
directory.  That will invoke the `polytype` generator, which will
