...
func (o Owner) MarshalJSON() ([]byte, error) {
	...
	if wrapper.IF, err = __jsonMarshal__interfaces_options__IFace__9888525f2a81affb3b56c3003f3ffefcfa04e42a8d62573bc2616617b6597ffc(o.IF); err != nil {
...
func (o *Owner) UnmarshalJSON(data []byte) (err error) {
	...
	if __decoded0, err = __jsonUnmarshal__interfaces_options__IFace__9888525f2a81affb3b56c3003f3ffefcfa04e42a8d62573bc2616617b6597ffc(wrapper.IF); err != nil {
		return err
	}
...
func __jsonMarshal__interfaces_options__IFace__9888525f2a81affb3b56c3003f3ffefcfa04e42a8d62573bc2616617b6597ffc(value IFace) (json.RawMessage, error) {
	if value == nil {
...
func __jsonUnmarshal__interfaces_options__IFace__9888525f2a81affb3b56c3003f3ffefcfa04e42a8d62573bc2616617b6597ffc(data []byte) (IFace, error) {
	var (
