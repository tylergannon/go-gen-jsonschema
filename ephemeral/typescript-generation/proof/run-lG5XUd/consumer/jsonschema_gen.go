...
func (e Envelope) MarshalJSON() ([]byte, error) {
	...
	if wrapper.Event, err = __jsonMarshal__consumer__Event__7b80ba593bcfaf94065840e7f72166656294ad0bb328f96662c827c192a80238(e.Event); err != nil {
		return nil, fmt.Errorf("field event: %w", err)
	}

	if wrapper.Other, err = __jsonMarshal__consumer__Event__5dfb70e024b2a784b1840320a1f304f3fa6212d1e23a59911046bb87b79a5a4c(e.Other); err != nil {
		return nil, fmt.Errorf("field other: %w", err)
	}

	if e.Maybe.Present {
		if wrapper.Maybe, err = __jsonMarshal__consumer__Event__7b80ba593bcfaf94065840e7f72166656294ad0bb328f96662c827c192a80238(e.Maybe.Value); err != nil {
	...
	for __index, __value := range e.Events {
		if __raw3[__index], err = __jsonMarshal__consumer__Event__7b80ba593bcfaf94065840e7f72166656294ad0bb328f96662c827c192a80238(__value); err != nil {
...
func (e *Envelope) UnmarshalJSON(data []byte) (err error) {
	...
	if __decoded0, err = __jsonUnmarshal__consumer__Event__7b80ba593bcfaf94065840e7f72166656294ad0bb328f96662c827c192a80238(wrapper.Event); err != nil {
		return err
	}
	__next.Event = __decoded0

	var __decoded1 Event
	if __decoded1, err = __jsonUnmarshal__consumer__Event__5dfb70e024b2a784b1840320a1f304f3fa6212d1e23a59911046bb87b79a5a4c(wrapper.Other); err != nil {
		return err
	}
	...
	if len(wrapper.Maybe) > 0 {
		...
		if __decoded2, err = __jsonUnmarshal__consumer__Event__7b80ba593bcfaf94065840e7f72166656294ad0bb328f96662c827c192a80238(wrapper.Maybe); err != nil {
			return err
		}
	...
	if len(wrapper.Events) > 0 {
		...
		for __index, __raw := range __raw3 {
			if __decoded3[__index], err = __jsonUnmarshal__consumer__Event__7b80ba593bcfaf94065840e7f72166656294ad0bb328f96662c827c192a80238(__raw); err != nil {
...
func __jsonMarshal__consumer__Event__7b80ba593bcfaf94065840e7f72166656294ad0bb328f96662c827c192a80238(value Event) (json.RawMessage, error) {
	if value == nil {
...
func __jsonUnmarshal__consumer__Event__7b80ba593bcfaf94065840e7f72166656294ad0bb328f96662c827c192a80238(data []byte) (Event, error) {
	var (
...
func __jsonMarshal__consumer__Event__5dfb70e024b2a784b1840320a1f304f3fa6212d1e23a59911046bb87b79a5a4c(value Event) (json.RawMessage, error) {
	if value == nil {
		return nil, fmt.Errorf("cannot marshal nil registered interface Event")
	}
	var (
...
func __jsonUnmarshal__consumer__Event__5dfb70e024b2a784b1840320a1f304f3fa6212d1e23a59911046bb87b79a5a4c(data []byte) (Event, error) {
	var (
		temp          map[string]json.RawMessage
		discriminator string
		err           = json.Unmarshal(data, &temp)
