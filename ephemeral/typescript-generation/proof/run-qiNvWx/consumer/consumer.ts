...
const created: Envelope["event"] = { "type": "Created", name: "Ada" };
const deleted: Envelope["event"] = { "type": "Deleted", id: 1 };
...
const wrongTag: Envelope["event"] = { "type": "wrong", name: "Ada" };
// @ts-expect-error branches preserve payload requirements
const wrongPayload: Envelope["event"] = { "type": "Created", id: 1 };
