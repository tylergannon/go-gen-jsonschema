...
func (e Envelope) MarshalJSON() ([]byte, error) {
	...
	if wrapper.Event, err = __jsonMarshal__consumer__Event__8efb41d4a142f3818284f65928d6b123c7ea56b45ddcce6cc43e192af7513d8f(e.Event); err != nil {
		return nil, fmt.Errorf("field event: %w", err)
	}

	if wrapper.Other, err = __jsonMarshal__consumer__Event__8efb41d4a142f3818284f65928d6b123c7ea56b45ddcce6cc43e192af7513d8f(e.Other); err != nil {
		return nil, fmt.Errorf("field other: %w", err)
	}

	if e.Maybe.Present {
		if wrapper.Maybe, err = __jsonMarshal__consumer__Event__8efb41d4a142f3818284f65928d6b123c7ea56b45ddcce6cc43e192af7513d8f(e.Maybe.Value); err != nil {
	...
	for __index, __value := range e.Events {
		if __raw3[__index], err = __jsonMarshal__consumer__Event__8efb41d4a142f3818284f65928d6b123c7ea56b45ddcce6cc43e192af7513d8f(__value); err != nil {
...
func (e *Envelope) UnmarshalJSON(data []byte) (err error) {
	...
	if __decoded0, err = __jsonUnmarshal__consumer__Event__8efb41d4a142f3818284f65928d6b123c7ea56b45ddcce6cc43e192af7513d8f(wrapper.Event); err != nil {
		return err
	}
	__next.Event = __decoded0

	var __decoded1 Event
	if __decoded1, err = __jsonUnmarshal__consumer__Event__8efb41d4a142f3818284f65928d6b123c7ea56b45ddcce6cc43e192af7513d8f(wrapper.Other); err != nil {
		return err
	}
	...
	if len(wrapper.Maybe) > 0 {
		...
		if __decoded2, err = __jsonUnmarshal__consumer__Event__8efb41d4a142f3818284f65928d6b123c7ea56b45ddcce6cc43e192af7513d8f(wrapper.Maybe); err != nil {
			return err
		}
	...
	if len(wrapper.Events) > 0 {
		...
		for __index, __raw := range __raw3 {
			if __decoded3[__index], err = __jsonUnmarshal__consumer__Event__8efb41d4a142f3818284f65928d6b123c7ea56b45ddcce6cc43e192af7513d8f(__raw); err != nil {
...
func __jsonMarshal__consumer__Event__8efb41d4a142f3818284f65928d6b123c7ea56b45ddcce6cc43e192af7513d8f(value Event) (json.RawMessage, error) {
	if value == nil {
...
func __jsonUnmarshal__consumer__Event__8efb41d4a142f3818284f65928d6b123c7ea56b45ddcce6cc43e192af7513d8f(data []byte) (Event, error) {
	var (
