...
func (e Envelope) MarshalJSON() ([]byte, error) {
	...
	if wrapper.Event, err = __jsonMarshal__consumer__Event__cb55f102156cbfd3977a9ec987b57702150e7e67ae0d2fbbb794b205139fe6b0(e.Event); err != nil {
		return nil, fmt.Errorf("field event: %w", err)
	}

	if wrapper.Other, err = __jsonMarshal__consumer__Event__7ccc8e3c20ee3ede3a94ae4e00d20a4a22d131307fe8bfc8077c15ae939d44c5(e.Other); err != nil {
		return nil, fmt.Errorf("field other: %w", err)
	}

	if e.Maybe.Present {
		if wrapper.Maybe, err = __jsonMarshal__consumer__Event__cb55f102156cbfd3977a9ec987b57702150e7e67ae0d2fbbb794b205139fe6b0(e.Maybe.Value); err != nil {
	...
	for __index, __value := range e.Events {
		if __raw3[__index], err = __jsonMarshal__consumer__Event__cb55f102156cbfd3977a9ec987b57702150e7e67ae0d2fbbb794b205139fe6b0(__value); err != nil {
...
func (e *Envelope) UnmarshalJSON(data []byte) (err error) {
	...
	if __decoded0, err = __jsonUnmarshal__consumer__Event__cb55f102156cbfd3977a9ec987b57702150e7e67ae0d2fbbb794b205139fe6b0(wrapper.Event); err != nil {
		return err
	}
	__next.Event = __decoded0

	var __decoded1 Event
	if __decoded1, err = __jsonUnmarshal__consumer__Event__7ccc8e3c20ee3ede3a94ae4e00d20a4a22d131307fe8bfc8077c15ae939d44c5(wrapper.Other); err != nil {
		return err
	}
	...
	if len(wrapper.Maybe) > 0 {
		...
		if __decoded2, err = __jsonUnmarshal__consumer__Event__cb55f102156cbfd3977a9ec987b57702150e7e67ae0d2fbbb794b205139fe6b0(wrapper.Maybe); err != nil {
			return err
		}
	...
	if len(wrapper.Events) > 0 {
		...
		for __index, __raw := range __raw3 {
			if __decoded3[__index], err = __jsonUnmarshal__consumer__Event__cb55f102156cbfd3977a9ec987b57702150e7e67ae0d2fbbb794b205139fe6b0(__raw); err != nil {
...
func __jsonMarshal__consumer__Event__cb55f102156cbfd3977a9ec987b57702150e7e67ae0d2fbbb794b205139fe6b0(value Event) (json.RawMessage, error) {
	if value == nil {
...
func __jsonUnmarshal__consumer__Event__cb55f102156cbfd3977a9ec987b57702150e7e67ae0d2fbbb794b205139fe6b0(data []byte) (Event, error) {
	var (
...
func __jsonMarshal__consumer__Event__7ccc8e3c20ee3ede3a94ae4e00d20a4a22d131307fe8bfc8077c15ae939d44c5(value Event) (json.RawMessage, error) {
	if value == nil {
		return nil, fmt.Errorf("cannot marshal nil registered interface Event")
	}
	var (
...
func __jsonUnmarshal__consumer__Event__7ccc8e3c20ee3ede3a94ae4e00d20a4a22d131307fe8bfc8077c15ae939d44c5(data []byte) (Event, error) {
	var (
		temp          map[string]json.RawMessage
		discriminator string
		err           = json.Unmarshal(data, &temp)
